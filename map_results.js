...
const coachThatWasMapped = document.getElementById('coaches');
const usersThatWereMapped = document.getElementById('users-mapped');

for (let i=0;i<coachCount;i++) {
    // Assign Coach info to li and push to coach div
    const li = document.createElement("li");
    console.log(Object.keys(coaches)[i]);
    li.textContent = `CDU Mapped: ${Object.keys(coaches)[i]}`
